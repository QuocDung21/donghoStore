...
@section('content')
    ...
    <main class="main">
                        ...
                        <div class="row mt10 mb5">
                            <div class="col-md-12 text-center">
                                <a href="{{ route('frontend.register') }}"
                                   class="btn white-btn text-initial mr10 mb5 font-bold active">{{ __('I am a customer') }}</a>
                            ...
                            <form class="form" method="POST" action="{{ route('frontend.customer-register') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="cursor: pointer;margin-top: 5px"
                                         class="d-flex justify-content-lg-end cursor-pointer">
                                        <span style="cursor: pointer" class="toggle-password cursor-pointer"
                                              onclick="togglePasswordVisibility()">{{__('Show Password')}}</span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="cursor: pointer;margin-top: 5px"
                                         class="d-flex justify-content-lg-end cursor-pointer">
                                        <span style="cursor: pointer" class="toggle-password-cf cursor-pointer"
                                              onclick="toggleCtPasswordVisibility()">{{__('Show Password')}}</span>
                                    </div>
                                </div>
        ...
        <script>
            ...
            function toggleCtPasswordVisibility() {
                const passwordInput = document.querySelector('input[name="password_confirmation"]');
                const toggleButton = document.querySelector('.toggle-password-cf');
