...
@if($gtext['is_subscribe_footer'] == 1)
    <section class="footer-top"
             style="background-image: url({{ asset('public/media/'.$gtext['subscribe_background_image']) }});">
        <div class="container">
            <div class="row">
...
@if($FooterSection->is_publish == 1)
    <footer class="footer-section "
            style="background-image: url({{ $FooterSection->image ? asset('public/media/'.$FooterSection->image) : '' }});background-color: #d1e9ef">
                                ...
                                <div class="footer-widget mb25">
                                    <div class="info-card">
                                        @if($gtext['about_logo_footer'] != '')
                                            <div class="info-logo">
                                                <img src="{{ asset('public/media/'.$gtext['about_logo_footer']) }}"
                                                     alt=""/>
                                            </div>
                                        @endif
