                ...
                <div class="row">
                    <div class="col-xl-5">
                        <div class="product-details-slider pd-slider-for">
                            ...
                            @else
                                <div class="item">
                                    <img src="{{ asset('public/media/'.$data->f_thumbnail) }}"
                                         alt="{{ $data->title }}"/>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="pr_details">
                            ...
                            <div class="product_price">
                                @if($data->sale_price != '')
                                    @if($gtext['currency_position'] == 'left')
                                        <div
                                            class="item-price">{{ $gtext['currency_icon'] }}{{ number_format($data->sale_price) }}</div>
                                    @else
                                        <div
                                            class="item-price">{{ number_format($data->sale_price) }}{{ $gtext['currency_icon'] }}</div>
                                    @endif
                                @endif
                                @if(($data->is_discount == 1) && ($data->old_price !=''))
                                    ...
                                    @if($gtext['currency_position'] == 'left')
                                        <div
                                            class="old-item-price">{{ $gtext['currency_icon'] }}{{ number_format($data->old_price) }}</div>
                                        <span class="discount">-{{ $discount }}%</span>
                                    @else
                                        <div
                                            class="old-item-price">{{ number_format($data->old_price) }}{{ $gtext['currency_icon'] }}</div>
                                        <span class="discount">-{{ $discount }}%</span>
                                    @endif
                                @endif
                            </div>
                            ...
                            @if($data->brandname != '')
                                <div class="pr_extra"><strong>{{ __('Brand') }}: </strong><a
                                        href="{{ route('frontend.brand', [$data->brand_id, str_slug($data->brandname)]) }}"> {{ $data->brandname }}</a>
                                </div>
                            @endif
                    ...
                    <div class="col-lg-12">
                        <div class="pr-description-review">
                            <div class="desc-review-nav nav">
                                <a class="active" href="#des_description"
                                                            ...
                                                            @else
                                                                ...
                                                                <a class="btn theme-btn"
                                                                   href="{{ route('frontend.login') }}"><i
                                                                        class="bi bi-box-arrow-in-right"></i> {{ __('Please Login') }}
                                                                </a>
                                                            @endif
                                                        </form>
                                                    </div>
                                                ...
                                                <div class="stores-card">
                                                    ...
                                                    <div class="desc">
                                                        ...
                                                        <div class="rating-wrap">
                                                            <div class="stars-outer">
                                                                <div class="stars-inner"
                                                                     style="width:{{ $SellerReview['ReviewPercentage'] }}%;"></div>
                                                            </div>
                                                        ...
                                                        <ul class="info">
                                                            ...
                                                            <li><i class="bi bi-envelope"></i>{{ $seller_data->email }}
                                                            </li>
