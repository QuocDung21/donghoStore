		...
		<div class="container">
			<div class="row my-dashbord">
				...
				<div class="col-sm-12 col-md-8 col-lg-9 col-xl-9">
					<div class="my_card d-flex justify-content-center text-center">
						<div class="row">
							<div class="col-lg-12">
								<h4>{{ __('Hello') }}, @if(isset(Auth::user()->name)) {{ Auth::user()->name }} @endif</h4>
								<p>Từ bảng điều khiển tài khoản của bạn. bạn có thể xem  <strong><a href="{{ route('frontend.my-orders') }}">những đơn đặt hàng gần đây </a></strong>, <strong><a href="{{ route('frontend.my-profile') }}">thông tin cá nhân</a></strong> và <strong><a href="{{ route('frontend.change-password') }}">đổi mật khẩu</a></strong>.</p>
							</div>
						</div>
					</div>
				</div>
