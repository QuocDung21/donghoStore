					...
					<div class="register">
						...
						<form class="form" method="POST" action="{{ route('frontend.sellerRegister') }}">
							...
							<div class="form-group">
								...
								<div style="cursor: pointer;margin: 3px"  class="d-flex justify-content-lg-end cursor-pointer">
									<span style="cursor: pointer"  class="toggle-password cursor-pointer" onclick="togglePasswordVisibility()">{{__('Show Password')}}</span>
								</div>
							...
							<div class="form-group">
								...
								<div style="cursor: pointer;margin: 3px" class="d-flex justify-content-lg-end cursor-pointer">
									<span style="cursor: pointer"  class="toggle-password-cf cursor-pointer" onclick="toggleCtPasswordVisibility()">{{__('Show Password')}}</span>
								</div>
							</div>
