						...
						<div class="row mb-10">
							<div class="col-lg-12">
								<div class="group-button">
									...
									<button id="orderstatus_{{ $row->id }}" type="button" onClick="onDataViewByStatus({{ $row->id }})" class="btn btn-theme orderstatus">{{ __($row->ostatus_name) }} (@php echo OrderCountForSeller($row->id); @endphp)</button>
									@endforeach
								</div>
