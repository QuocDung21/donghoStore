                                    ...
                                    <div class="col-lg-12">
                                        <div class="group-button">
                                            <button id="orderstatus_0" type="button" onclick="onDataViewByStatus(0)"
                                                    class="btn btn-theme orderstatus active">All ({{ $AllCount }})
                                            </button>
                                            <button id="orderstatus_1" type="button" onclick="onDataViewByStatus(1)"
                                                    class="btn btn-theme orderstatus">{{ __('Active') }}
                                                ({{ $ActiveCount }})
                                            </button>
                                            <button id="orderstatus_2" type="button" onclick="onDataViewByStatus(2)"
                                                    class="btn btn-theme orderstatus">{{ __('Inactive') }}
                                                ({{ $InactiveCount }})
                                            </button>
                                        </div>
...
{{--                                                                    class="fa fa-reply"></i> {{ __('Back to List') }}--}}
{{--                                                        </a>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
...
{{--                                        <!--/Data Entry Form-->--}}
{{--                                        <div class="card-body">--}}
{{--                                            <a onClick="onDetailsBankInfo(1)" href="javascript:void(0);"--}}
{{--                                               id="details_bank_info_1"--}}
{{--                                               class="btn custom-btn font-bold mr-10 details_bank_info active">{{ __('Details') }}</a>--}}
{{--                                            <a onClick="onDetailsBankInfo(2)" href="javascript:void(0);"--}}
{{--                                               id="details_bank_info_2"--}}
{{--                                               class="btn custom-btn font-bold details_bank_info">{{ __('Bank Information') }}</a>--}}
...
{{--                                                        <div class="col-md-6">--}}
{{--                                                            <div class="form-group">--}}
{{--                                                                <label for="shop_url">{{ __('Shop URL') }}<span--}}
{{--                                                                            class="red">*</span></label>--}}
...
{{--                                                        <div class="col-md-6">--}}
{{--                                                            <div class="form-group">--}}
{{--                                                                <label for="phone">{{ __('Shop Phone') }}<span--}}
{{--                                                                            class="red">*</span></label>--}}
...
{{--                                                        <div class="col-md-6">--}}
{{--                                                            <div class="form-group">--}}
{{--                                                                <label for="status_id">{{ __('Active/Inactive') }}<span--}}
{{--                                                                            class="red">*</span></label>--}}
...
{{--                                                                    </a>--}}
{{--                                                                </div>--}}
{{--                                                                <em>Recommended image size width: 200px and height:--}}
{{--                                                                    200px.</em>--}}
{{--                                                                <div id="remove_photo_thumbnail" class="select-image">--}}
{{--                                                                    <div class="inner-image"--}}
{{--                                                                         id="view_photo_thumbnail"></div>--}}
{{--                                                                    <a onClick="onMediaImageRemove('photo_thumbnail')"--}}
{{--                                                                       class="media-image-remove"--}}
...
{{--                                                                       id="account_holder" class="form-control">--}}
{{--                                                            </div>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
...
{{--                                                    <input type="text" id="bank_information_id"--}}
{{--                                                           name="bank_information_id" class="dnone"/>--}}

{{--                                                    <div class="row tabs-footer mt-15">--}}
{{--                                                        <div class="col-lg-12">--}}
{{--                                                            <a id="bank_information_submit_form"--}}
                                    ...
                                    <div class="card mb-15">
                                        <div class="card-body">
                                            <div class="seller_card">
                                                <h5><strong>{{ __('Joined At') }}</strong> <span class="float-right"
                                                                                                 id="created_at"></span>
                                                </h5>
                                                <h6><strong>{{ __('Status') }}</strong> <span id="seller_status"
