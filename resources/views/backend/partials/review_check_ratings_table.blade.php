                ...
                <td class="text-center">
                    <div class="btn-group action-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a onclick="onCheck({{ $row->id }})" class="dropdown-item" href="javascript:void(0);">{{ __('Duyệt') }}</a>
                            <a onclick="onDelete({{ $row->id }})" class="dropdown-item" href="javascript:void(0);">{{ __('Từ chối') }}</a>
                        </div>
                    </div>
                </td>
            </tr>
