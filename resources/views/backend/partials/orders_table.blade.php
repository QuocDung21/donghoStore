	...
	<table class="table table-borderless table-theme" style="width:100%;">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-center"><span class="status_btn pstatus_{{ $row->payment_status_id }}">{{ __($row->pstatus_name) }}</span></td>
				<td class="text-center"><span class="status_btn ostatus_{{ $row->order_status_id }}">{{ __($row->ostatus_name) }}</span></td>
