			...
			<div class="col-lg-12">
				<div class="card">
					...
					<ul class="status_list">
						...
						<li id="payment_status_class" class="pstatus_{{ $mdata->payment_status_id }}"><strong>{{ __('Payment Status') }}</strong>: <span id="pstatus_name">{{ __($mdata->pstatus_name) }}</span></li>
						<li id="order_status_class" class="ostatus_{{ $mdata->order_status_id }}"><strong>{{ __('Order Status') }}</strong>: <span id="ostatus_name">{{ __($mdata->ostatus_name) }}</span></li>
					</ul>
					</div>
				</div>
			</div>
