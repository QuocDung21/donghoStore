...
<head>
    ...
    <style type="text/css">
        :root {
            ...
            --primary-font-family: 'Arial', sans-serif; /* Font chính cho văn bản tiếng Việt */
            --secondary-font-family: 'Spartan', sans-serif; /* Font phụ */
            --arabic-font-family: 'Noto Kufi Arabic', sans-serif; /* Font cho tiếng Ả Rập */
