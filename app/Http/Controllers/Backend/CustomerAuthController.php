    ...
    public function CustomerRegister(Request $request)
    {
        ...
        if ($recaptcha == 1) {
            $request->validate([
                ...
                'password' => 'required|confirmed|min:8|password_complexity',
            ], [
                'g-recaptcha-response.required' => 'Trường recaptcha là bắt buộc',
                ...
                'password_complexity' => 'Mật khẩu phải chứa ít nhất một chữ hoa, một chữ thường và một ký tự đặc biệt',
